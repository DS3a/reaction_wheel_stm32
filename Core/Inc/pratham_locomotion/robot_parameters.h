#ifndef _ROS_pratham_locomotion_robot_parameters_h
#define _ROS_pratham_locomotion_robot_parameters_h
...
namespace pratham_locomotion
{
  ...
  class robot_parameters : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "pratham_locomotion/robot_parameters"; };
