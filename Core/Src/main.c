...
/* Definitions for bldc_Task */
osThreadId_t bldc_TaskHandle;
const osThreadAttr_t bldc_Task_attributes = {
  .name = "bldc_Task",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* USER CODE BEGIN Header_rosserial_entry */
/**
...
/* USER CODE BEGIN Header_bldc_entry */
/**
* @brief Function implementing the bldc_Task thread.
* @param argument: Not used
* @retval None
*/
